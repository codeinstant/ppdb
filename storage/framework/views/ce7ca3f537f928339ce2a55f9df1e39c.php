<?php $__env->startSection('title','Edit Jawaban'); ?>
...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <form role="form" action="<?php echo e(route('jawaban.update',$Jawaban->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                      ...
                      <option value="<?php echo e($sek->id); ?>"
                          <?php echo e($Jawaban->soal->id == $sek->id ? 'selected' : ''); ?>>
                          <?php echo e($sek->soal); ?>
...
unset($__errorArgs, $__bag); ?>" name="jawaban" ><?php echo e($Jawaban->jawaban); ?></textarea>
...
<?php echo $__env->make('layouts.pmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/panitia/jawaban/edit.blade.php ENDPATH**/ ?>