                                ...
                                <form action="<?php echo e(route('siswa.formulir')); ?>" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="gelombang" name="gelombang" placeholder="gelombang"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php elseif($pendaftar->status == 1 || $pendaftar->status == 2): ?>
                                <a href="<?php echo e(route('siswa.pengumuman')); ?>" class="btn btn-info">Lihat Pengumuman</a>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/siswa/form.blade.php ENDPATH**/ ?>