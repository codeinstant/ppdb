...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <form role="form" 
              <?php if(isset($detail)): ?> 
                action="<?php echo e(route('tentang.update', $detail->id)); ?>" 
              <?php else: ?> 
                action="<?php echo e(route('tentang.store')); ?>" 
              <?php endif; ?> 
              method="POST">
            <?php echo csrf_field(); ?>
            <?php if(isset($detail)): ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="card-footer">
              ...
              <a href="<?php echo e(isset($detail) ? route('tentang.edit', $detail->id) : route('tentang.create')); ?>" class="btn btn-secondary"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
            </div>
          </form>
        <!-- /.card-body -->
      </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/admin/tentang/create.blade.php ENDPATH**/ ?>