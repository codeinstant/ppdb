    ...
    <br />
      <div class="isisurat" style="margin-left: 90px">
        <p style="text-align:justify">
          Kepada<br />
          Yth. <?php echo e($pendaftar->user->name); ?><br />
          <br />
          di <br />
          Tempat
          <br />
        ...
        <p style="text-align:justify">
          ...
          <p style="text-indent: 10mm; margin-bottom: 0px;">
            Bersama dengan surat ini atas nama <?php echo e($pendaftar->user->name); ?> dengan NIK <?php echo e($pendaftar->nik); ?>
...
<?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/siswa/cetakformulir.blade.php ENDPATH**/ ?>