        ...
        <div class="col-12">
          ...
          <!-- /.card -->
            <div class="card-header">
              <a href="<?php echo e(route('soal.create')); ?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-dark">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo e($sek->soal); ?></td>
                    <td><?php echo e($sek->tipe_soal); ?></td>
                    <td>
                      <a href="<?php echo e(route('soal.edit',$sek->id)); ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i> Edit</a>
                      <form action="<?php echo e(route('soal.delete', $sek->id)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.pmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/panitia/soal/index.blade.php ENDPATH**/ ?>