...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo e(route('login')); ?>"><b>Selamat Datang di PPDB Online</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
...
unset($__errorArgs, $__bag); ?>
      ...
      <p class="mb-0">
        <a href="<?php echo e(route('register')); ?>" class="text-center">Daftar Siswa Baru</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
...
<?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/auth/login.blade.php ENDPATH**/ ?>