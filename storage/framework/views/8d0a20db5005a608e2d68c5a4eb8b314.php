<?php $__env->startSection('title','Pendaftar Ditolak'); ?>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo e(route('pendaftar.detail',$pendaf->id)); ?>" class="btn btn-sm btn-info"><i class="fas fa-eye"></i> Detail</a>
                    </td>
                  </tr>
                  <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kodekulaku\projek\ppdb-master\resources\views/admin/pendaftar/tolak.blade.php ENDPATH**/ ?>