          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table class="table table-striped mb-5">
                <tbody>
                  <?php $__currentLoopData = $tentang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>Nama Sekolah</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo e(route('tentang.edit',$detail->id)); ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i> Edit</a>
                    </td>
                  </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/admin/tentang/index.blade.php ENDPATH**/ ?>