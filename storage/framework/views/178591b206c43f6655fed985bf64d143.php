                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title m-0"><?php echo $__env->yieldContent('title'); ?> Gelombang ke-<?php echo e($pendaftar->penerimaan->gelombang); ?> Tahun Angkatan <?php echo e($pendaftar->penerimaan->tahun_angkatan); ?></h5>
                        </div>
                        <div class="card-body">
