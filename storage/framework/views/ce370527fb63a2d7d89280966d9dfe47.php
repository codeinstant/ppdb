                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php if($detail->status == 1): ?>
                                <!-- Jika status = 1 -->
                                <form action="<?php echo e(route('pendaftar.updateterima', $detail->id)); ?>" method="POST"
                                    class="d-inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('pendaftar.updatetolak', $detail->id)); ?>" method="POST"
                                    class="d-inline">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php elseif($detail->status == 2): ?>
                                ...
                                <button class="btn btn-primary" data-toggle="modal"
                                    data-target="#modal<?php echo e($detail->id); ?>">
                                    Ubah Status
                                </button>

                                <!-- Modal -->
                                <div class="modal fade" id="modal<?php echo e($detail->id); ?>" tabindex="-1" role="dialog"
                                    aria-labelledby="modalTitle<?php echo e($detail->id); ?>" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="<?php echo e(route('pendaftar.updatetolak', $detail->id)); ?>"
                                ...
                                <div class="modal fade" id="modal<?php echo e($detail->id); ?>" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- Isi modal, seperti form untuk mengubah status -->
                                                <form action="<?php echo e(route('pendaftar.updateterima', $detail->id)); ?>"
                                                    method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
