                                ...
                                <form action="<?php echo e(route('siswa.formulir')); ?>" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" id="penerimaan_id" name="penerimaan_id" value="<?php echo e($gelombang->id); ?>" hidden>
                                            <input type="text" class="form-control" id="gelombang" placeholder="gelombang"
                                                value="<?php echo e($gelombang->gelombang); ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Tahun Angkatan</label>
                                            <input type="text" class="form-control" id="tahun_angkatan" placeholder="tahun_angkatan"
                                                value="<?php echo e($gelombang->tahun_angkatan); ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">NIK</label>
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="nik" value="<?php echo e(old('nik')); ?>">
                                            <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio1" name="jenis_kelamin"
                                                ...
                                                <?php if(old('jenis_kelamin')): ?> checked <?php endif; ?>>
                                            <label class="custom-control-label" for="customRadio1">Laki-Laki</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio2" name="jenis_kelamin"
                                                class="custom-control-input" value="Perempuan" <?php if(old('jenis_kelamin')): ?>
                                                checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                            id=""><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="kecamatan" value="<?php echo e(old('kecamatan')); ?>">
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="kabupaten" value="<?php echo e(old('kabupaten')); ?>">
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="provinsi" value="<?php echo e(old('provinsi')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                id="inputCity" value="<?php echo e(old('tanggal_lahir')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select
                                                class="form-control select2bs4 <?php $__errorArgs = ['jurusan_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="<?php echo e($sek->id); ?>"
                                                    <?php echo e(old('jurusan_id') == $sek->id ? 'selected' : ''); ?>>
                                                    <?php echo e($sek->nama); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                id="inputCity" value="<?php echo e(old('no_telp')); ?>">
                                            <?php $__errorArgs = ['no_telp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file" name="ijasah"
                                                class="form-control-file <?php $__errorArgs = ['ijasah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Nilai Matematika" value="<?php echo e(old('matematika')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" name="ipa"
                                                class="form-control <?php $__errorArgs = ['ipa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Nilai IPA" value="<?php echo e(old('ipa')); ?>">
                                            <?php $__errorArgs = ['ipa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" name="bhs_indo"
                                                class="form-control <?php $__errorArgs = ['bhs_indo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Nilai Bahasa Indonesia" value="<?php echo e(old('bhs_indo')); ?>">
                                            <?php $__errorArgs = ['bhs_indo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" name="bhs_inggris"
                                                class="form-control <?php $__errorArgs = ['bhs_inggris'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="Nilai Bahasa Inggris" value="<?php echo e(old('bhs_inggris')); ?>">
                                            <?php $__errorArgs = ['bhs_inggris'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="Nama Ayah" value="<?php echo e(old('nama_ayah')); ?>">
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="Nama Ibu" value="<?php echo e(old('nama_ibu')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_ortu"
                                            class="form-control <?php $__errorArgs = ['alamat_ortu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" name="no_hp_ortu"
                                                class="form-control <?php $__errorArgs = ['no_hp_ortu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="No HP Orang Tua" value="<?php echo e(old('no_hp_ortu')); ?>">
                                            <?php $__errorArgs = ['no_hp_ortu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="Pekerjaan Ayah" value="<?php echo e(old('pekerjaan_ayah')); ?>">
...
unset($__errorArgs, $__bag); ?>" id=""
                                                placeholder="Pekerjaan Ibu" value="<?php echo e(old('pekerjaan_ibu')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="penghasilan_ortu"
                                            class="form-control <?php $__errorArgs = ['penghasilan_ortu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id=""
                                            value="<?php echo e(old('penghasilan_ortu')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php elseif($pendaftar->status == 1 || $pendaftar->status == 2 || $pendaftar->status == 3): ?>
                                <a href="/pengumuman/<?php echo e($gelombang->id); ?>" class="btn btn-info">Lihat Pengumuman</a>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kodekulaku\projek\ppdb-master\resources\views/siswa/form.blade.php ENDPATH**/ ?>