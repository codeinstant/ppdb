<?php $__env->startSection('title','Tambah Gelombang'); ?>
...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <form role="form" action="<?php echo e(route('gelombang.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" name="tahun_angkatan" placeholder="Tahun Angkatan" value="<?php echo e(old('tahun_angkatan')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="gelombang" placeholder="Gelombang" value="<?php echo e(old('gelombang')); ?>">
                <span class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>" name="kuota" placeholder="Kuota" value="<?php echo e(old('kuota')); ?>">
                <span class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>" name="buka" placeholder="Buka" value="<?php echo e(old('buka')); ?>">
                <span class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>" name="tutup" placeholder="Tutup" value="<?php echo e(old('tutup')); ?>">
                <span class="invalid-feedback">
...
<?php echo $__env->make('layouts.pmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ppdb-master\resources\views/panitia/gelombang/create.blade.php ENDPATH**/ ?>