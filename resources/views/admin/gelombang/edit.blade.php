                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                name="tahun_angkatan" placeholder="Tahun Angkatan" value="{{ $gelombang->tahun_angkatan }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control col-lg-6 @error('gelombang') is-invalid @enderror"
                                name="gelombang" placeholder="Gelombang" value="{{ $gelombang->gelombang }}">
                            <span class="invalid-feedback">
                                @error('gelombang')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control col-lg-6 @error('kuota') is-invalid @enderror"
                                name="kuota" placeholder="Kuota" value="{{ $gelombang->kuota }}">
                            <span class="invalid-feedback">
                                @error('kuota')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control col-lg-6 @error('buka') is-invalid @enderror"
                                name="buka" placeholder="Buka" value="{{ $gelombang->buka }}">
                            <span class="invalid-feedback">
                                @error('buka')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control col-lg-6 @error('tutup') is-invalid @enderror"
                                name="tutup" placeholder="Tutup" value="{{ $gelombang->tutup }}">
                            <span class="invalid-feedback">
                                @error('tutup')
                                    {{ $message }}
                                @enderror
