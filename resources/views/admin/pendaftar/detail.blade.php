      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
             ...
             <table class="table table-striped mb-5">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ url('storage/', $detail->foto) }}" alt="" style="height: 150px"></td>
                        <td>Ijasah</td>
                        <td><img src="{{ url('storage/', $detail->ijasah) }}" alt="" style="height: 150px"></td>
                    </tr>
                    <tr>
                        <td>Ayah</td>
            ...
            @if ($detail->status == 1)
                <!-- Jika status = 1 -->
                <form action="{{ route('pendaftar.updateterima', $detail->id) }}" method="POST" class="d-inline">
                    @csrf
                    <button class="btn btn-success" onclick="return confirm('Apakah anda ingin menerima?')">
                        <i class="fas fa-check-circle"></i> Terima
                    </button>
                </form>
                <form action="{{ route('pendaftar.updatetolak', $detail->id) }}" method="POST" class="d-inline"> 
                    @csrf
            ...
            @elseif ($detail->status == 2)
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#modal{{ $detail->id }}">
                    Ubah Status
                </button>

                <!-- Modal -->
                <div class="modal fade" id="modal{{ $detail->id }}" tabindex="-1" role="dialog" aria-labelledby="modalTitle{{ $detail->id }}" aria-hidden="true">
