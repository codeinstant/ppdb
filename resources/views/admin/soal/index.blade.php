                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('soal.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i>
                                Tambah</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($Soal as $sek)
                                        <tr>
                                            ...
                                            <td>{{ $sek->tipe_soal }}</td>
                                            <td>
                                                <a href="{{ route('soal.edit', $sek->id) }}"
                                                    class="btn btn-sm btn-success"><i class="fas fa-edit"></i> Edit</a>
                                                <form action="{{ route('soal.delete', $sek->id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('delete')
