                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="ml-3 mr-3">
                                ...
                                <form action="{{ route('siswa.formulir') }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" id="penerimaan_id" name="penerimaan_id" value="{{ $gelombang->id }}" hidden>
                                            <input type="text" class="form-control" id="gelombang" placeholder="gelombang"
                                                value="{{ $gelombang->gelombang }}" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio2" name="jenis_kelamin"
                                                class="custom-control-input" value="Perempuan" @if(old('jenis_kelamin'))
                                                checked @endif>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" name="bhs_indo"
                                                ...
                                                placeholder="Nilai Bahasa Indonesia" value="{{ old('bhs_indo') }}">
                                            @error('bhs_indo')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="number" name="bhs_inggris"
                                                ...
                                                placeholder="Nilai Bahasa Inggris" value="{{ old('bhs_inggris') }}">
                                            @error('bhs_inggris')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" name="no_hp_ortu"
                                                class="form-control @error('no_hp_ortu') is-invalid @enderror" id=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="penghasilan_ortu"
                                            class="form-control @error('penghasilan_ortu') is-invalid @enderror" id=""
                                ...
                                @elseif($pendaftar->status == 1 || $pendaftar->status == 2 || $pendaftar->status == 3)
                                <a href="/pengumuman/{{ $gelombang->id }}" class="btn btn-info">Lihat Pengumuman</a>
                                @endif
                            </div>
