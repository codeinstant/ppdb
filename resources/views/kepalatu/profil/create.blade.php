    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <form role="form"
                    @if (isset($detail)) action="{{ route('kepala.profil.update', $detail->id) }}" 
              @else 
                action="{{ route('kepala.profil.store') }}" @endif
                    method="POST">
                    @csrf
                    @if (isset($detail))
                        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-lg-6 @error('nama_sekolah') is-invalid @enderror"
                                ...
                                value="{{ isset($detail) ? $detail->nama_sekolah : old('nama_sekolah') }}">
                            ...
                            <input type="text"
                                ...
                                value="{{ isset($detail) ? $detail->nama_kpl_sekolah : old('nama_kpl_sekolah') }}">
                            ...
                            <input type="text"
                                ...
                                value="{{ isset($detail) ? $detail->nip_kpl_sekolah : old('nip_kpl_sekolah') }}">
                            ...
                            <input type="img"
                                ...
                                value="{{ isset($detail) ? $detail->ttd_kpl_sekolah : old('ttd_kpl_sekolah') }}">
                            ...
                            <input type="text"
                                ...
                                value="{{ isset($detail) ? $detail->nama_ketua_ppdb : old('nama_ketua_ppdb') }}">

                            <label for="nip_ppdb">NIP PPDB</label>
                            <input type="text" class="form-control col-lg-6 @error('nip_ppdb') is-invalid @enderror"
                                name="nip_ppdb" placeholder="NIP PPDB"
                                value="{{ isset($detail) ? $detail->nip_ppdb : old('nip_ppdb') }}">
                            ...
                            <input type="text"
                                ...
                                value="{{ isset($detail) ? $detail->alamat_sekolah : old('alamat_sekolah') }}">
                            ...
                            <input type="text" class="form-control col-lg-6 @error('tel_sekolah') is-invalid @enderror"
                                ...
                                value="{{ isset($detail) ? $detail->tel_sekolah : old('tel_sekolah') }}">
                            ...
                            <input type="text" class="form-control col-lg-6 @error('web_sekolah') is-invalid @enderror"
                                ...
                                value="{{ isset($detail) ? $detail->web_sekolah : old('web_sekolah') }}">
                            ...
                            <input type="text"
                                ...
                                value="{{ isset($detail) ? $detail->email_sekolah : old('email_sekolah') }}">
                            ...
                            <input type="text" class="form-control col-lg-6 @error('logo_sekolah') is-invalid @enderror"
                                ...
                                value="{{ isset($detail) ? $detail->logo_sekolah : old('logo_sekolah') }}">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ isset($detail) ? route('kepala.profil.edit', $detail->id) : route('kepala.profil.create') }}"
                            class="btn btn-secondary"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
                    </div>
                </form>
                <!-- /.card-body -->
            </div>
